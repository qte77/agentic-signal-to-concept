...
surveying more candidate sources (SourceHut, MLH, Kaggle, Hugging Face, YC directory, etc.) is
in progress.
...
| Additional candidate sources (SourceHut, MLH, Kaggle, Hugging Face, YC directory, etc.) | **in progress** (2026-09-05) | Dispatched as a research pass; not yet landed. Update this row, don't add a duplicate, once it reports back. |
